...
let create_1K () =
  ...
  let expected = {
    ...
    crypt_method = `None; l1_size = 1l; l1_table_offset = Qcow.Physical.make ~is_mutable:false 131072L;
...
let create_1P () =
  ...
  let expected = {
    ...
    crypt_method = `None; l1_size = 2097152l; l1_table_offset = Qcow.Physical.make ~is_mutable:false 131072L;
    refcount_table_offset = Qcow.Physical.make ~is_mutable:false 65536L; refcount_table_clusters = 1l;
    nb_snapshots = 0l; snapshots_offset = 0L; additional;
    extensions = [ `Feature_name_table Qcow.Header.Feature.understood ];
  } in
